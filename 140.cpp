...
//			neu minduong == -1 tra vê gia tri -1
//			duyet các phân tu tu dau mang toi cuoi mang, neu co phan tu nào (a[i] > 0) và a[i] < minduong thi minduong = a[i]
...
{
	float minDuong = timduongdautien(a, n);
	if(minDuong == -1){
...
int main()
{
	...
	float minDuong = timgiatriduongnhonhat(a, n);
	printf("\nGia tri duong nho nhat la %f", minDuong);
